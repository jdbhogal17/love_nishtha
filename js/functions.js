...
function timeElapse(startDate) {
	...
	const elapsedSeconds = Math.floor((current - new Date(startDate)) / 1000); // Total elapsed seconds
  ...
  // Example Usage
  const startDate = "2024-12-12T12:30:00"; // Define start time
  setInterval(() => timeElapse(startDate), 1000); // Update every second
